...
mod_sn_street_info_app <- function(street_name, gisco_id) {
  ui <- fluidPage(
    mod_sn_street_info_ui("snm_street_info_ui_1")
  )
...
# mod_sn_street_info_app(street_name = "Belvedere San Francesco", gisco_id = "IT_022205")
