...
sn_get_details <- function(id,
  ...
  df_l <- tibble::tibble(qid = id) %>% 
    dplyr::mutate(label = tidywikidatar::tw_get_label(qid, language = language, cache_connection = db_connection, disconnect_db = FALSE, cache = cache, id_df = qid_tw_df), 
    ...
    dplyr::mutate(place_of_birth_label = tidywikidatar::tw_get_label(place_of_birth_qid, language = language, cache_connection = db_connection, disconnect_db = FALSE, cache = cache),
    ...
    dplyr::mutate(place_of_birth_country_label = tidywikidatar::tw_get_label(place_of_birth_country_qid, language = language, cache_connection = db_connection, disconnect_db = FALSE, cache = cache),
    ...
    dplyr::mutate(place_of_death_label = tidywikidatar::tw_get_label(place_of_death_qid, language = language, cache_connection = db_connection, disconnect_db = FALSE, cache = cache),
    ...
    dplyr::mutate(place_of_death_country_label = tidywikidatar::tw_get_label(place_of_death_country_qid, language = language, cache_connection = db_connection, disconnect_db = FALSE, cache = cache),
  ...
  tidywikidatar::tw_disconnect_from_cache(cache = cache, cache_connection = db_connection, disconnect_db = TRUE, language = language)
